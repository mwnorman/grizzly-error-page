...
public class TestResourceTest  {
    ...
    @BeforeClass
    public static void setUpResourceTestBase() throws IOException {
        ...
        client = ClientBuilder
            ...
            .register(new ClientResponseFilter() {
                ...
                public void filter(ClientRequestContext requestContext, ClientResponseContext responseContext) {
                    ...
                    {
                        clientEntity = scanner.hasNext() ? scanner.next() : "";
                    }
                    catch (IOException e) {
                        // ignore
                    }
    ...
    public void test_getId_invalidId() {
        WebTarget webResource = client
            ...
            .resolveTemplate(ID_PATHPARAM, "this_is_an_invalid_userAccountId")
        ;
    ...
    static class TestResourceApplication extends ResourceConfig {
        public TestResourceApplication() {
            ...
            registerInstances(new LoggingFilter(Logger.getLogger(TestResourceApplication.class.getName()), true));
        }
    }
